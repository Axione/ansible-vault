...
* **lint:** Templated files should use template instead of copy ([aa43735](https://github.com/Axione/ansible-vault/commit/aa437354db200459e5adbf92ddf6f1ce4963f17c))
